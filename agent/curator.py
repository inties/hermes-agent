...
CURATOR_REVIEW_PROMPT = (
    ...
    "The right target shape is CLASS-LEVEL skills with concise SKILL.md "
    "bodies + `references/`, `templates/`, and `scripts/` subfiles for "
    "reusable support material — not one-session-one-skill micro-entries "
    "and not transcript or scene logs embedded in skills.\n\n"
    ...
    "      • `references/<topic>.md` for reusable support material: "
    "condensed knowledge banks (quoted research, API docs excerpts, "
    "domain notes), provider quirks, or compact recurring reproduction "
    "recipes. Do not preserve chat transcripts, private scenes, full task "
    "narratives, or one-off project state as references.\n"
