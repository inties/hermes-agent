...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "Create only when a durable reusable procedure exists for a recurring "
        "task class. Do not create skills for a single conversation, one-off "
        "task narrative, private interaction, project daily state, or merely "
        "because errors were overcome.\n"
        "Update when: instructions stale/wrong, a reusable workflow changed, "
        "or durable missing steps or pitfalls were found during use. "
        "If you used a skill and hit issues not covered by it, patch it immediately.\n\n"
        "After difficult/iterative tasks, offer to save a generalized procedure "
        "as a skill only if it will clearly recur. Skip simple one-offs and "
        "scene-specific content. Confirm with user before creating/deleting.\n\n"
        "Good skills: trigger conditions, concise reusable steps, exact commands "
        "where needed, pitfalls, and verification steps. Use references/ for "
        "compact reusable support material, not transcripts or full task logs.\n\n"
